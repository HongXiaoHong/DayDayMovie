...
function gotoURL( url ){
	...
	<div id="page_head">
		...
		<div style="float:right;margin-right:10px;">
			...
			<a href="${pageContext.request.contextPath }/cinema/toUploadPage">上传</a>&nbsp;&nbsp;
			当前用户: ${user.name }&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;
			<img src="${pageContext.request.contextPath }/images/btn_user.jpg"/>&nbsp;&nbsp;
			<a href="${pageContext.request.contextPath }/User/loginout"> 退出登陆 </a>
		</div>
...
<div id="menu">
	<ul>
		...
		<div id="d_right" style="background:white;">
			<div class="d_bar">个人资料 > 编辑资料</div>
			<div id="mv_list">
				<!-- /PlayList/add  -->
				<div style="margin-left:25px;margin-top:25px;">
				<form id="frmMovie" action="${pageContext.request.contextPath }/User/saveUser" method="post">
					<input type="hidden" name="id" value="yk5uhvpk11po10i6bk2863ch716e0ge7"/>
					<table>
						<tr>
							<td class="td1">用户昵称</td>
							<td><input type="text" name="user.nickName" value="${user.nickName }"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<div class="frmButton" onclick="doSubmit();">保存</div>
							<div class="frmButton" onclick="gotoURL( '/User/infoManage' );">重置</div>
							</td>							
						</tr>
