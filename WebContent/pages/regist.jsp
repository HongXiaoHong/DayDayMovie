...
<div id="outbox">
	<div id="up_box">
		<table>
			<form id="userForm" action="/Movie/User/regist"
				accept-charset="UTF-8" method="post">
			<tr>
				<td colspan="2" class="head"><label>用户注册</label></td>		
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align:left;"><input type="text" name="user.nickName"/></td>
			</tr>
			<tr>
				<td style="text-align:right;">邮箱</td>
				<td style="text-align:left;"><input type="text" name="user.email"/></td>
			</tr>
			<tr>
				<td style="text-align:right;">qq</td>
				<td style="text-align:left;"><input type="text" name="user.qq"/></td>
			</tr>
			<tr>
				<td colspan="2" align="center" valign="middle" height="90">
				<img id="btnLogin" src="../images/img_register.png" onClick="gotoSub();"/>
				</td>
			</tr>
			</form>
		</table>
